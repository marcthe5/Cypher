...
public class DECRYPT extends JFrame {
	...
	public DECRYPT() {
		...
		decryptedText.setBackground(Color.LIGHT_GRAY);
		decryptedText.setBounds(6, 262, 544, 190);
		...
		btnDecrypt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				decryption(text,list);
				decryptedText.setText(res);
		...
		btnDecrypt.setBounds(100, 212, 143, 39);
    ...
    //algorithms
	public static String decryption (String str, LinkedList<String> list) {
